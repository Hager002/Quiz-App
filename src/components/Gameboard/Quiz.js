...
export class Quiz extends Component {
  ...
  componentDidMount() {
    const { questions, previousQuestion, currentQuestion, nextQuestion } = this.state;

    this.displayAllQuestions(questions, previousQuestion, currentQuestion, nextQuestion);
  }
      ...
      <Fragment>
        ...
        <div className="questions">
          ...
          <div className="button-container">
            <button onClick={this.handleButtonClickPrevious} className="previous">
              Previous
            </button>
            <button onClick={this.handleButtonClickNext} className="next">
              Next
            </button>
            <button onClick={this.handleButtonClickQuit} className="quit">
              Quit
            </button>
          </div>
        </div>
